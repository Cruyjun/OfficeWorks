...
namespace OW.Web.UI.Toolbar
{
	...
	internal class ResX
	{
		...
		public static string GetResourceString(string name) 
		{
			...
			{
				// Current Culture
				_instance = new ResourceManager(String.Format("OW.Web.UI.Toolbar.Resources.{0}", CultureInfo.CurrentCulture), typeof(ResX).Assembly);
			...
			catch (Exception) 
			{
				...
				{
					// Neutral Culture
					_instance = new ResourceManager("OW.Web.UI.Toolbar.Resources.Resource", typeof(ResX).Assembly);
					return (_instance.GetString(name) == null ? name : _instance.GetString(name));
				}
				catch (Exception) 
				{
		...
		private static ResourceManager openResources(string selectedCulture)
		{
			return new ResourceManager(String.Format("OW.Web.UI.Toolbar.Resources.{0}", CultureInfo.CreateSpecificCulture(selectedCulture)), typeof(ResX).Assembly);
		}
