...
namespace OfficeWorks.NetworkManager
{
	...
	/// <summary>
	/// This class Enumerates over a set of servers returning the server's name.
	/// </summary>
	...
	/// <summary>
	/// This Class that encapsulates the Win32 API call of NetServerEnum
	/// </summary>
